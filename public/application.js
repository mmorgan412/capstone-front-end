...
var config = {
  apiOrigins: {
    production: 'https://mels-capstone.herokuapp.com'
  }
};
...
var setAPIOrigin = __webpack_require__(132);
var config = __webpack_require__(6);
var authevents = __webpack_require__(134);
var petevents = __webpack_require__(153);
var appointmentevents = __webpack_require__(162);
...
var parseNestedQuery = __webpack_require__(133);
...
var authui = __webpack_require__(135);
...
var store = __webpack_require__(4);
var showNavbarUserTemplate = __webpack_require__(136);
var authapi = __webpack_require__(9);
...
var showUserDropdown = function showUserDropdown(response) {
  var showUserHtml = showNavbarUserTemplate({ user: response.user });
  $('#user-dropdown').html(showUserHtml);
};

var onSignOut = function onSignOut(event) {
  event.preventDefault();
  authapi.signOut().then(signOutSuccess).catch(signOutFailure);
};
...
module.exports = (Handlebars["default"] || Handlebars).template({"compiler":[7,">= 4.0.0"],"main":function(container,depth0,helpers,partials,data) {
  ...
  return "<a class=\"dropdown-toggle\" data-toggle=\"dropdown\" href=\"#\"><i class=\"fa fa-user-o\" aria-hidden=\"true\"></i>  "
    + container.escapeExpression(container.lambda(((stack1 = (depth0 != null ? depth0.user : depth0)) != null ? stack1.email : stack1), depth0))
    + "\n  <span class=\"caret\"></span>\n</a>\n\n<ul class=\"dropdown-menu\" id=\"user-dropdown\">\n  <li>\n    <a href=\"#\" class=\"nav-links\" id=\"change-password-link\" data-toggle=\"modal\" data-target=\"#change-password-form\">Change Password</a>\n  </li>\n  <li>\n    <a href=\"#\" class=\"nav-links\" id=\"sign-out-link\">Sign Out</a>\n  </li>\n</ul>\n";
},"useData":true});
...
var _handlebarsSafeString = __webpack_require__(149);
...
var _handlebarsRuntime = __webpack_require__(150);

var runtime = _interopRequireWildcard(_handlebarsRuntime);

var _handlebarsNoConflict = __webpack_require__(151);
...
var _helpersBlockHelperMissing = __webpack_require__(139);

var _helpersBlockHelperMissing2 = _interopRequireDefault(_helpersBlockHelperMissing);

var _helpersEach = __webpack_require__(140);

var _helpersEach2 = _interopRequireDefault(_helpersEach);

var _helpersHelperMissing = __webpack_require__(141);

var _helpersHelperMissing2 = _interopRequireDefault(_helpersHelperMissing);

var _helpersIf = __webpack_require__(142);

var _helpersIf2 = _interopRequireDefault(_helpersIf);

var _helpersLog = __webpack_require__(143);

var _helpersLog2 = _interopRequireDefault(_helpersLog);

var _helpersLookup = __webpack_require__(144);

var _helpersLookup2 = _interopRequireDefault(_helpersLookup);

var _helpersWith = __webpack_require__(145);
...
var getFormFields = __webpack_require__(7);
var petsApi = __webpack_require__(154);
var petsUi = __webpack_require__(155);
var store = __webpack_require__(4);
var showPetsNameTemplate = __webpack_require__(161);

var onAddPet = function onAddPet(event) {
  event.preventDefault();
  var data = getFormFields(this);
  petsApi.createPet(data).then(petsUi.addPetSuccess).catch(petsUi.addPetFailure);
};

var onGetPets = function onGetPets(event) {
  event.preventDefault();
  petsApi.getPets().then(petsUi.getPetsSuccess).then(onGetPet).then(onGetPetDropdown).catch(petsUi.getPetsFailure);
};

var getPetHandler = function getPetHandler(index) {
  petsApi.getPet(index).then(petsUi.getPetSuccess).then(onDeletePet).then(onEditPet).then(onUpdatePet).catch(petsUi.getPetFailure);
};

var onGetPet = function onGetPet(event) {
...
var onGetPetDropdown = function onGetPetDropdown(event) {
...
var onDeletePet = function onDeletePet() {
  $('.remove').one('click', function (event) {
    var index = $(event.target).attr('data-id');
    var petName = event.target.innerText.split(' ').pop();
    var showPetNameHtml = showPetsNameTemplate({ pet: petName });
...
var confirmDeleteButton = function confirmDeleteButton(index) {
  $('#confirm-delete-pet').one('click', function () {
    confirmDeletePet(index);
  });
};

var confirmDeletePet = function confirmDeletePet(index) {
  petsApi.deletePet(index).then(petsUi.deletePetSuccess).catch(petsUi.deletePetFailure);
};

var onEditPet = function onEditPet() {
  $('.edit').on('click', function (event) {
    var index = $(event.target).attr('data-id');
    petsApi.getPet(index).then(function (data) {
      var petName = data.pet.name;
      var licenseNumber = data.pet.license_number;
      var breed = data.pet.breed;
      var insuranceInfo = data.pet.insurance_info;
      var vet = data.pet.vet;
      var url = data.pet.url;
      var id = data.pet.id;
...
var onUpdatePet = function onUpdatePet() {
  $('#update-pet').on('submit', function (event) {
    event.preventDefault();
    var data = getFormFields(this);
    petsApi.updatePet(data, store.petId).then(petsUi.updatePetSuccess).then(function (result) {
...
var updatePet = function updatePet(data, petId) {
  return $.ajax({
...
var deletePet = function deletePet(data) {
  return $.ajax({
...
var searchPets = function searchPets(data) {
  return $.ajax({
...
var showPetsTemplate = __webpack_require__(156);
var showPetTemplate = __webpack_require__(157);
var store = __webpack_require__(4);
var showPetsDropdownTemplate = __webpack_require__(158);
var showPetDropdownTemplate = __webpack_require__(159);
var showPetsMessageTemplate = __webpack_require__(160);
...
var addPetFailure = function addPetFailure() {
...
var getPetsSuccess = function getPetsSuccess(data) {
  ...
  var showPetsDropdownHtml = showPetsDropdownTemplate({ pets: data.pets });
  $('#pets-dropdown').html(showPetsDropdownHtml);
  var showPetsHtml = showPetsTemplate({ pets: data.pets });
  $('#pet-list').html(showPetsHtml);
  var noPets = 'Welcome!  Add a pet to start!';
  var hasPets = '';
  if (data.pets.length === 0) {
    var showPetsMessageHtml = showPetsMessageTemplate({ message: noPets });
    $('#landing-page-message').html(showPetsMessageHtml);
  } else {
    var _showPetsMessageHtml = showPetsMessageTemplate({ message: hasPets });
    $('#landing-page-message').html(_showPetsMessageHtml);
    data.pets.forEach(function (obj) {
      obj.letter = obj.name.charAt(0).toUpperCase();
    });
    var _showPetsHtml = showPetsTemplate({ pets: data.pets });
    $('#pet-list').html(_showPetsHtml);
  }
};

var deletePetSuccess = function deletePetSuccess() {
  $('#get-pets').trigger('click');
  $('#appointment-list').hide();
  $('#pet-dropdown').hide();
  $('#show-one-pet').hide();
...
var deletePetFailure = function deletePetFailure() {
  console.log('error with deletePet');
};

var getPetSuccess = function getPetSuccess(data) {
  var showPetHtml = showPetTemplate(data);
  $('#show-one-pet').show();
  $('#show-one-pet').html(showPetHtml);
  store.pets = data.pet;
  $('#get-appointments').trigger('click');
  $('#new-appointment').show();
  var showPetDropdownHtml = showPetDropdownTemplate(data);
...
module.exports = {
  ...
  getPetSuccess: getPetSuccess,
  getPetsFailure: getPetsFailure,
  deletePetSuccess: deletePetSuccess,
  deletePetFailure: deletePetFailure,
...
module.exports = (Handlebars["default"] || Handlebars).template({"1":function(container,depth0,helpers,partials,data,blockParams) {
  ...
  return "\n<!-- go through pets array and do something on each one -->\n\n          <button type=\"button\" data-id=\""
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.id : stack1), depth0))
    + "\" class=\"numberCircle col-xs-3\" data-toggle=\"tooltip\" data-placement=\"top\" title=\""
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.name : stack1), depth0))
    + "\">\n                  "
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.letter : stack1), depth0))
    + "\n          </button>\n\n\n";
},"compiler":[7,">= 4.0.0"],"main":function(container,depth0,helpers,partials,data,blockParams) {
    var stack1;

  return "<div class=\"button-center\">\n\n"
...
module.exports = (Handlebars["default"] || Handlebars).template({"1":function(container,depth0,helpers,partials,data) {
  ...
  return "          <p><b>Breed:</b>  "
    + container.escapeExpression(container.lambda(((stack1 = (depth0 != null ? depth0.pet : depth0)) != null ? stack1.breed : stack1), depth0))
    + "</p>\n";
},"3":function(container,depth0,helpers,partials,data) {
    return "          <p><b>Breed:</b> Not Available</p>\n";
},"5":function(container,depth0,helpers,partials,data) {
    var stack1;

  return "            <p><b>License Number:</b>  "
    + container.escapeExpression(container.lambda(((stack1 = (depth0 != null ? depth0.pet : depth0)) != null ? stack1.license_number : stack1), depth0))
    + "</p>\n";
},"7":function(container,depth0,helpers,partials,data) {
    return "            <p><b>License Number:</b> Not Available</p>\n";
},"9":function(container,depth0,helpers,partials,data) {
    var stack1;

  return "            <p><b>Insurance Info:</b>  "
    + container.escapeExpression(container.lambda(((stack1 = (depth0 != null ? depth0.pet : depth0)) != null ? stack1.insurance_info : stack1), depth0))
    + "</p>\n";
},"11":function(container,depth0,helpers,partials,data) {
    return "            <p><b>Insurance Info:</b> Not Available</p>\n";
},"13":function(container,depth0,helpers,partials,data) {
    var stack1;

  return "          <p><b>Vet:</b>  "
    + container.escapeExpression(container.lambda(((stack1 = (depth0 != null ? depth0.pet : depth0)) != null ? stack1.vet : stack1), depth0))
    + "</p>\n";
},"15":function(container,depth0,helpers,partials,data) {
    return "           <p><b>Vet:</b> Not Available</p>\n";
},"compiler":[7,">= 4.0.0"],"main":function(container,depth0,helpers,partials,data) {
    var stack1, alias1=container.lambda, alias2=container.escapeExpression, alias3=depth0 != null ? depth0 : (container.nullContext || {});

  return "\n      <div class=\"col-sm-3 col-md-6\">\n        <div class=\"thumbnail\">\n          <h4><a href=\"#\" class=\"hb-buttons thumbnail-images contextDisplay\" data-trigger=\"focus\" data-toggle=\"popover\" title=\"Image Properties\" data-html=\"true\"></a></h4>\n          <img src=\""
    + alias2(alias1(((stack1 = (depth0 != null ? depth0.pet : depth0)) != null ? stack1.url : stack1), depth0))
    + "\" onerror=this.src=\"https://t4.ftcdn.net/jpg/01/80/09/95/240_F_180099575_xy59UxoDEfNH34iELATEVbrGvACCop7b.jpg\">\n        </div>\n      </div>\n      <div class=\"grid col-sm-3 col-md-6\">\n        <h2>"
    + alias2(alias1(((stack1 = (depth0 != null ? depth0.pet : depth0)) != null ? stack1.name : stack1), depth0))
    + "</h2>\n"
    + ((stack1 = helpers["if"].call(alias3,((stack1 = (depth0 != null ? depth0.pet : depth0)) != null ? stack1.breed : stack1),{"name":"if","hash":{},"fn":container.program(1, data, 0),"inverse":container.program(3, data, 0),"data":data})) != null ? stack1 : "")
    + "\n\n"
    + ((stack1 = helpers["if"].call(alias3,((stack1 = (depth0 != null ? depth0.pet : depth0)) != null ? stack1.license_number : stack1),{"name":"if","hash":{},"fn":container.program(5, data, 0),"inverse":container.program(7, data, 0),"data":data})) != null ? stack1 : "")
    + "\n"
    + ((stack1 = helpers["if"].call(alias3,((stack1 = (depth0 != null ? depth0.pet : depth0)) != null ? stack1.insurance_info : stack1),{"name":"if","hash":{},"fn":container.program(9, data, 0),"inverse":container.program(11, data, 0),"data":data})) != null ? stack1 : "")
    + "\n"
    + ((stack1 = helpers["if"].call(alias3,((stack1 = (depth0 != null ? depth0.pet : depth0)) != null ? stack1.vet : stack1),{"name":"if","hash":{},"fn":container.program(13, data, 0),"inverse":container.program(15, data, 0),"data":data})) != null ? stack1 : "")
    + "\n\n      </div>\n";
},"useData":true});
...
module.exports = (Handlebars["default"] || Handlebars).template({"1":function(container,depth0,helpers,partials,data,blockParams) {
  ...
  return "\n    <li><a class=\"pet-dropdown\" data-id=\""
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.id : stack1), depth0))
    + "\" href=\"#\">"
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.name : stack1), depth0))
    + "</a></li>\n\n";
  ...
  return "\n\n\n"
    + ((stack1 = helpers.each.call(depth0 != null ? depth0 : (container.nullContext || {}),(depth0 != null ? depth0.pets : depth0),{"name":"each","hash":{},"fn":container.program(1, data, 1, blockParams),"inverse":container.noop,"data":data,"blockParams":blockParams})) != null ? stack1 : "")
    + "\n\n<li><a href=\"#\" class=\"nav-links\" id=\"add-pet-link\" data-toggle=\"modal\" data-target=\"#add-pet-form\"><b>Add New Pet</b></a></li>\n";
},"useData":true,"useBlockParams":true});
...
module.exports = (Handlebars["default"] || Handlebars).template({"compiler":[7,">= 4.0.0"],"main":function(container,depth0,helpers,partials,data) {
  ...
  return "\n\n<a class=\"dropdown-toggle\" data-toggle=\"dropdown\" href=\"#\">"
    + alias2(alias1(((stack1 = (depth0 != null ? depth0.pet : depth0)) != null ? stack1.name : stack1), depth0))
    + "\n  <span class=\"caret\"></span>\n</a>\n\n<ul class=\"dropdown-menu\" id=\"pet-dropdown\">\n<li><a class=\"pet-dropdown edit\" href=\"#\" data-id=\""
    + alias2(alias1(((stack1 = (depth0 != null ? depth0.pet : depth0)) != null ? stack1.id : stack1), depth0))
    + "\" data-toggle=\"modal\" data-target=\"#edit-pet-modal\">Update</a></li>\n\n<li><a class=\"pet-dropdown remove\" data-toggle=\"modal\" data-target=\"#pet-delete-modal\" href=\"#\" data-id=\""
    + alias2(alias1(((stack1 = (depth0 != null ? depth0.pet : depth0)) != null ? stack1.id : stack1), depth0))
    + "\" >Remove "
    + alias2(alias1(((stack1 = (depth0 != null ? depth0.pet : depth0)) != null ? stack1.name : stack1), depth0))
    + "</a></li>\n</ul>\n";
...
module.exports = (Handlebars["default"] || Handlebars).template({"compiler":[7,">= 4.0.0"],"main":function(container,depth0,helpers,partials,data) {
  ...
  return "\n\n<div class=\"row container-fluid row col-xs-12 text-center\" id=\"landing-message\">\n  <h1> "
...
module.exports = (Handlebars["default"] || Handlebars).template({"compiler":[7,">= 4.0.0"],"main":function(container,depth0,helpers,partials,data) {
  ...
  return "\n\nAre you sure you want to delete "
    + container.escapeExpression(((helper = (helper = helpers.pet || (depth0 != null ? depth0.pet : depth0)) != null ? helper : helpers.helperMissing),(typeof helper === "function" ? helper.call(depth0 != null ? depth0 : (container.nullContext || {}),{"name":"pet","hash":{},"data":data}) : helper)))
    + "?\n";
},"useData":true});
...
var getFormFields = __webpack_require__(7);
var appointmentsApi = __webpack_require__(163);
var appointmentsUi = __webpack_require__(164);
var store = __webpack_require__(4);
// const moment = require('moment')

var onAddAppointment = function onAddAppointment(event) {
  event.preventDefault();
  var id = store.pets.id;
  $("input[name='appointment[pet_id]'").val(id);
  var data = getFormFields(this);
  appointmentsApi.createAppointment(data).then(appointmentsUi.addAppointmentSuccess).catch(appointmentsUi.addAppointmentFailure);
};

var onGetAppointments = function onGetAppointments(event) {
  event.preventDefault();
  appointmentsApi.getAppointments(store.pets.id).then(appointmentsUi.getAppointmentsSuccess).then(onDeleteAppointment).then(onEditAppointment).then(onUpdateAppointment).catch(appointmentsUi.getAppointmentsFailure);
};
...
var confirmDelete = function confirmDelete(index) {
  appointmentsApi.deleteAppointment(index).then(appointmentsUi.deleteAppointmentSuccess).catch(appointmentsUi.deleteAppointmentFailure);
};

var onEditAppointment = function onEditAppointment() {
  $('.edit-appointment').on('click', function (event) {
    var index = $(event.target).attr('data-id');
    appointmentsApi.getAppointment(index).then(function (data) {
      var appointmentDate = data.appointment.date;
      var appointmentTime = data.appointment.time;
      var weight = data.appointment.weight;
      var description = data.appointment.description;
      var cost = data.appointment.cost;
      var notes = data.appointment.notes;
      var id = data.appointment.id;
      var petId = data.appointment.pet_id;
...
var onUpdateAppointment = function onUpdateAppointment() {
  $('#update-appointment').on('submit', function (event) {
    event.preventDefault();
    var data = getFormFields(this);
    appointmentsApi.updateAppointment(data, store.appointmentId).then(appointmentsUi.updateAppointmentSuccess).catch(appointmentsUi.updateAppointmentFailure);
  });
};

var addAppointmentHandlers = function addAppointmentHandlers() {
...
module.exports = {
  addAppointmentHandlers: addAppointmentHandlers
};
/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(1)))
...
var createAppointment = function createAppointment(data) {
  return $.ajax({
...
var getAppointments = function getAppointments(petId) {
  return $.ajax({
...
var getAppointment = function getAppointment(id) {
  return $.ajax({
...
var updateAppointment = function updateAppointment(data, appointmentId) {
  return $.ajax({
...
var deleteAppointment = function deleteAppointment(data) {
  return $.ajax({
...
var showAppointmentsTemplate = __webpack_require__(165);
var moment = __webpack_require__(0);

var addAppointmentSuccess = function addAppointmentSuccess(data) {
  $('#get-appointments').trigger('click');
...
var getAppointmentsSuccess = function getAppointmentsSuccess(data) {
  ...
  if (data.appointments.length > 0) {
    var showAppointmentHtml = showAppointmentsTemplate(data);
...
var updateAppointmentSuccess = function updateAppointmentSuccess(data) {
...
var updateAppointmentFailure = function updateAppointmentFailure() {
...
module.exports = {
  ...
  addAppointmentFailure: addAppointmentFailure,
  getAppointmentsSuccess: getAppointmentsSuccess,
  deleteAppointmentSuccess: deleteAppointmentSuccess,
  updateAppointmentSuccess: updateAppointmentSuccess,
  updateAppointmentFailure: updateAppointmentFailure
};
/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(1)))
...
module.exports = (Handlebars["default"] || Handlebars).template({"1":function(container,depth0,helpers,partials,data,blockParams) {
  ...
  return "\n    <tr>\n      <th scope=\"row\"></th>\n      <td>"
    ...
    + "      <td>\n      <a href=\"#\" class=\"hb-buttons thumbnail-images contextDisplay\" data-trigger=\"focus\" data-toggle=\"popover\" title=\"Appointment\" data-html=\"true\"\n        data-content=\n\n        \"<b>Date:</b> "
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.date : stack1), depth0))
    + "<br/>\n        <b>Time:</b> "
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.time : stack1), depth0))
    + "<br/>\n\n"
    + ((stack1 = helpers["if"].call(alias3,((stack1 = blockParams[0][0]) != null ? stack1.cost : stack1),{"name":"if","hash":{},"fn":container.program(6, data, 0, blockParams),"inverse":container.program(8, data, 0, blockParams),"data":data,"blockParams":blockParams})) != null ? stack1 : "")
    + "\n"
    + ((stack1 = helpers["if"].call(alias3,((stack1 = blockParams[0][0]) != null ? stack1.weight : stack1),{"name":"if","hash":{},"fn":container.program(10, data, 0, blockParams),"inverse":container.program(12, data, 0, blockParams),"data":data,"blockParams":blockParams})) != null ? stack1 : "")
    + "\n"
    + ((stack1 = helpers["if"].call(alias3,((stack1 = blockParams[0][0]) != null ? stack1.description : stack1),{"name":"if","hash":{},"fn":container.program(14, data, 0, blockParams),"inverse":container.program(16, data, 0, blockParams),"data":data,"blockParams":blockParams})) != null ? stack1 : "")
    + "\n\n"
    + ((stack1 = helpers["if"].call(alias3,((stack1 = blockParams[0][0]) != null ? stack1.notes : stack1),{"name":"if","hash":{},"fn":container.program(18, data, 0, blockParams),"inverse":container.program(20, data, 0, blockParams),"data":data,"blockParams":blockParams})) != null ? stack1 : "")
    + "\" >\n\n        See More\n      </a>\n      <button data-id=\""
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.id : stack1), depth0))
    + "\" type=\"button\"\n      class=\"remove-appointment btn btn-outline-danger\" data-target=\"#appointment-delete-modal\" data-toggle=\"modal\">Remove</button>\n      <button data-id=\""
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.id : stack1), depth0))
    + "\"type=\"button\" class=\"edit-appointment btn btn-warning\" data-toggle=\"modal\" data-target=\"#edit-appointment-modal\">Update</button></td>\n    </tr>\n\n";
  ...
  return "          <b>Cost:</b> $"
    + container.escapeExpression(container.lambda(((stack1 = blockParams[1][0]) != null ? stack1.cost : stack1), depth0))
    + "<br/>\n";
},"8":function(container,depth0,helpers,partials,data) {
    return "          <b>Cost:</b> Not Available<br/>\n";
},"10":function(container,depth0,helpers,partials,data,blockParams) {
    var stack1;

  return "          <b>Weight:</b> "
    + container.escapeExpression(container.lambda(((stack1 = blockParams[1][0]) != null ? stack1.weight : stack1), depth0))
    + " lbs<br/>\n";
},"12":function(container,depth0,helpers,partials,data) {
    return "          <b>Weight:</b> Not Available<br/>\n";
  ...
  return "          <b>Description:</b> "
    ...
    return "          <b>Description:</b> Not Available<br/>\n";
  ...
  return "          <b>Notes:</b> "
    ...
    return "          <b>Notes:</b> Not Available\n        ";
},"compiler":[7,">= 4.0.0"],"main":function(container,depth0,helpers,partials,data,blockParams) {
    var stack1;

  return "<table class=\"table table-hover text-center\">\n  <thead>\n    <tr>\n      <th></th>\n      <th>Date</th>\n      <th>Time</th>\n      <th>Description</th>\n    </tr>\n  </thead>\n  <tbody>\n\n"
